...
TOKEN_MERGE_USE_PSG_IMPORTANCE="${TOKEN_MERGE_USE_PSG_IMPORTANCE:-false}"
TOKEN_MERGE_LAYER_GATE_GROUP_SIZE="${TOKEN_MERGE_LAYER_GATE_GROUP_SIZE:-6}"
TOKEN_MERGE_LAYER_GATE_KEEP_PER_GROUP="${TOKEN_MERGE_LAYER_GATE_KEEP_PER_GROUP:-3}"
TOKEN_MERGE_LAYER_GATE_TAU="${TOKEN_MERGE_LAYER_GATE_TAU:-1.0}"
...
TOKEN_MERGE_ARGS+=(--token_merge_use_psg_importance "${TOKEN_MERGE_USE_PSG_IMPORTANCE}")
TOKEN_MERGE_ARGS+=(--token_merge_layer_gate_group_size "${TOKEN_MERGE_LAYER_GATE_GROUP_SIZE}")
TOKEN_MERGE_ARGS+=(--token_merge_layer_gate_keep_per_group "${TOKEN_MERGE_LAYER_GATE_KEEP_PER_GROUP}")
TOKEN_MERGE_ARGS+=(--token_merge_layer_gate_tau "${TOKEN_MERGE_LAYER_GATE_TAU}")
TOKEN_MERGE_ARGS+=(--token_merge_layer_gate_logit_scale "${TOKEN_MERGE_LAYER_GATE_LOGIT_SCALE}")
