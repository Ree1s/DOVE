#!/bin/bash
#SBATCH -J dove_stage1_tm        # Job name
...
#SBATCH --output=logs/dove_s1_tokenmerge_%j.out
#SBATCH --error=logs/dove_s1_tokenmerge_%j.err
...
export TOKEN_MERGE_ROUTES=${TOKEN_MERGE_ROUTES:-"10-17@0.36;28-35@0.36"}
...
export TOKEN_MERGE_WINDOW_SIZE=${TOKEN_MERGE_WINDOW_SIZE:-0}
...
cd finetune
bash ./train_ddp_one_s1_token_merge.sh
